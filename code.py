...
training_set = train_datagen.flow_from_directory( 'intel-image-classification\seg_train\seg_train', target_size=(64, 64), batch_size=32, class_mode='categorical')
test_set = test_datagen.flow_from_directory('intel-image-classification\seg_test\seg_test',target_size=(64, 64),batch_size=32,class_mode='categorical')
